				...
				<div className="about-text">
					...
					<div>
						<p className='d-flex align-items-center'>
							<h3>My cv:</h3>
							<a href='https://drive.google.com/file/d/1zDU-kRQsuAht3HOT5C2REuPPb4m31iSB/view?usp=drive_link' title='view' className='cv'>
							...
							<a href='https://drive.usercontent.google.com/u/0/uc?id=1zDU-kRQsuAht3HOT5C2REuPPb4m31iSB&export=download' title='download' className='cv' download >
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className=" cv w-6 h-6">
